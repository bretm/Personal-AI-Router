...
| `github.com/99designs/keyring` | v1.2.2 | ollama-proxy, lmstudio-proxy, nvpair-node-settings, nvpair-cluster-manager, nvpair-engine-manager | MIT | [LICENSE](https://github.com/99designs/keyring/blob/main/LICENSE) |

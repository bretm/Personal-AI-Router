...
`github.com/99designs/keyring` is linked by the engine-manager, node settings,
cluster manager, and both inference proxies to access the native OS credential
store. Platform helpers are linked only where their build tags apply.
...
| `github.com/99designs/keyring` | v1.2.2 | ollama-proxy, lmstudio-proxy, lemonade-proxy, nvpair-node-settings, nvpair-cluster-manager, nvpair-engine-manager | MIT | [LICENSE](https://github.com/99designs/keyring/blob/main/LICENSE) |
...
| `github.com/99designs/go-keychain` | v0.0.0-20191008050251-8e49817e8af4 | keyring (macOS) | MIT | [LICENSE](https://github.com/99designs/go-keychain/blob/master/LICENSE) |
...
| `github.com/danieljoos/wincred` | v1.1.2 | keyring (Windows) | MIT | [LICENSE](https://github.com/danieljoos/wincred/blob/master/LICENSE) |
| `github.com/dvsekhvalnov/jose2go` | v1.5.0 | keyring | MIT | [LICENSE](https://github.com/dvsekhvalnov/jose2go/blob/master/LICENSE) |
...
| `github.com/godbus/dbus` | v0.0.0-20190726142602-4481cbc300e2 | keyring (Linux) | BSD-3-Clause | [LICENSE](https://github.com/godbus/dbus/blob/master/LICENSE) |
| `github.com/gsterjov/go-libsecret` | v0.0.0-20161001094733-a6f4afe4910c | keyring (Linux) | MIT | [LICENSE](https://github.com/gsterjov/go-libsecret/blob/master/LICENSE) |
...
| `github.com/mtibben/percent` | v0.2.1 | keyring | MIT | [LICENSE](https://github.com/mtibben/percent/blob/master/LICENSE) |
...
| `golang.org/x/term` | v0.45.0 | keyring | BSD-3-Clause | [LICENSE](https://cs.opensource.google/go/x/term/+/master:LICENSE) |
